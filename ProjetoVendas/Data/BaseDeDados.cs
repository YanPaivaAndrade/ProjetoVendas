...
namespace ProjetoVendas.Data
{
    public class BaseDeDados
    {
        ...
        public void Gerar() 
        {
            ...
            HistoricoDeVendas hv3 = new HistoricoDeVendas(new DateTime(2020, 4, 11), 2500.00, StatusDeVenda.Vendido, v3);
            HistoricoDeVendas hv4 = new HistoricoDeVendas(new DateTime(2020, 2, 12), 500.00, StatusDeVenda.Vendido, v2);
            HistoricoDeVendas hv5 = new HistoricoDeVendas(new DateTime(2020, 1, 13), 10.00, StatusDeVenda.Vendido, v5);
